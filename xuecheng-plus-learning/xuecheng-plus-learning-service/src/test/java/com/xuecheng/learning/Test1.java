...
public class Test1 {
 ...
 ContentServiceClient contentServiceClient;
  ...
  @Test
 public void test(){
      Long testid=Long.valueOf(2);
   CoursePublish coursepublish = contentServiceClient.getCoursepublish(testid);
 ...
 public void test2(){
      ...
      PageResult<MyCourseTableItemDto> mycourestabls = myCourseTablesService.mycourestables(myCourseTableParams);
